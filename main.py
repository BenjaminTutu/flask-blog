...
# New table for the user comments database
...
def register():
    ...
    #     hashing and salting password before storing Database
...
def show_post(post_id):
    ...
    if comment_form.validate_on_submit():
        ...
        db.session.commit()
    return render_template("post.html", post=requested_post, current_user=current_user.is_authenticated, form=comment_form)
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", form=edit_form, is_edit=True, current_user=current_user.is_authenticated)
